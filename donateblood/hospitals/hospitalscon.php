   ...
   $telephone = $_POST['telephone'];
    $location = $_POST['location'];
	  if(!empty($ID) && !empty($name) && !empty($telephone) && !empty($location)){
	   ...
	   $sql = "INSERT INTO hospitals(ID,name,telephone,location) VALUES ('$ID','$name','$telephone','$location')";
...
<!--newtable inside big table -->
      ...
      <tr>
        ...
        <td>
          ...
          <div align="left">
            ...
            <input style="width:120px" name="del" type="button" id="del" value="Delete Record" onclick="location.href='/donateblood/hospitals/confirmdelete.php'" /> 
 ...
 <table width="330" border="1" align="center" style="margin-top:5px">
      <tr>
        <td><div align="center">
          <input name="view" type="submit" id="view" value="View blood count" onClick="location.href='/donateblood/blood/bloodcount.php'"/>
        </div></td>
      </tr>
    </table>
...
<?php 
  ...
  $location = $_POST['location'];
   ...
   if(!empty($ID) && !empty($name) && !empty($telephone) && !empty($location)){
 $query= "UPDATE hospitals SET name='$name', telephone='$telephone', location='$location' WHERE ID='$ID'";
if ($query_run= mysqli_query($con,$query)){
