...
<div id="templatemo_main">
  ...
  <form id="form1" name="form1" method="post" action="search.php">
    ...
    <table width="450" border="1" align="center">
      <tr>
        <th colspan="2" scope="col"><span class="style8">Insert hospital ID and click search to get details. To physicaly view the location go to the <a href="/donateblood/contact.html" >Contact Us</a> page </span>          <div align="left"></div></th>
      </tr>
      <tr>
        <td width="102"><span class="style3">Hospital ID </span></td>
        <td width="332"><input name="ID" type="text" id="ID" />
