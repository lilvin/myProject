...
<table width="332" height:300px; border="1" align="center" >
  ...
  <tr>
    <td width="143" bgcolor="#CC3366"><input name="update" type="submit" id="update" value="Update details"  onclick="location.href='/donateblood/menu/recipientsupdate.php'"/></td>
