...
<table width="332" height:400px; border="1" align="center" >
 ...
 <form id="form1" name="form1" method="post" action="recipientscon.php">
  ...
  <tr>
    <td width="135" bgcolor="#CC3366"><input name="update" type="submit" id="update" value="Update details"  onclick="location.href='/donateblood/menu/recipientsupdate.php'"/></td>
  ...
  <tr>
    <td bgcolor="#CC3366"><input name="cancel2" type="submit" id="cancel2" value="Cancel appointment" onclick="location.href='/donateblood/appointments/recipientscancel.php'"/></td>
    <td bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366">&nbsp;</td>
