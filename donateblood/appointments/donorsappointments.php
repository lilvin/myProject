...
<table width="332" height:300px; border="1" align="center" >
  ...
  <tr>
    <td width="143" bgcolor="#CC3366"><input name="update" type="submit" id="update" value="Update details"  onclick="location.href='/donateblood/menu/donorsupdate.php'"/></td>
    <td width="1" bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366"><input name="password" type="submit" id="password" value="Change Password" onclick="location.href='/donateblood/password/donorspassword.php'"/></td>
    <td bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366"><input name="hospital2" type="submit" id="hospital2" value="Search for hospital" onclick="location.href='/donateblood/hospitals/searchhospital.php'"/></td>
    <td bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
 ...
 <!-- <table width="513" border="1">
      <tr>
        <td colspan="2"><div align="center"><span class="style2 style4">Personal Details </span></div></td>
        <td colspan="2"><div align="center"><span class="style4">Blood Details</span> </div></td>
      </tr>
      <tr>
        <td width="90"><span class="style3">First Name </span></td>
        <td width="175"><form id="form2" name="form2" method="post" action="">
          <input name="firstname" type="text" id="firstname" />
        </form>
        </td>
        <td width="76"><span class="style3">Blood Type</span> </td>
        <td width="144"><input type="text" name="textfield5" /></td>
      </tr>
      <tr>
        <td><span class="style3">Last Name </span></td>
        <td><input name="lastname" type="text" id="lastname" /></td>
        <td><span class="style3">Rheus</span></td>
      ...
      <tr>
        <td><span class="style3">Mobile </span></td>
