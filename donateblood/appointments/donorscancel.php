...
<table width="332" height:300px; border="1" align="center" >
  ...
  <tr>
    <td width="140" bgcolor="#CC3366"><input name="update" type="submit" id="update" value="Update details"  onclick="location.href='/donateblood/menu/donorsupdate.php'"/></td>
  ...
  <tr>
    <td bgcolor="#CC3366"><input name="cancel2" type="submit" id="cancel2" value="Cancel appointment" onclick="location.href='/donateblood/appointments/donorscancel.php'"/></td>
    <td bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366">&nbsp;</td>
