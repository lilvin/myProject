...
$ID = $_POST['ID'];
 $date = $_POST['date'];
  ...
  $query ="SELECT * FROM donorsappointments WHERE (ID='$ID' AND date='$date')";
...
<?php 
 ...
 $query= "UPDATE recipientsappointments SET ID='$ID', mobile='$mobile', location='$location' , hospital='$hospital', date='$newdate' WHERE ID='$ID' AND date='$date'";
if ($query_run= mysqli_query($con,$query)){
	 ...
	 if (isset($_POST['all']))
{
  ...
  $query ="SELECT * FROM donorsappointments";
