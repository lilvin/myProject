...
<table width="332" height="332" border="1" align="center"  >
 ...
 <form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    <td width="144" bgcolor="#CC3366"><input name="update" type="submit" id="update" value="Update details"  onclick="location.href='/donateblood/menu/recipientsupdate.php'"/></td>
...
if ($dpassword==$password){
 ...
 $query= "UPDATE recipientsreg SET password='$newpassword_hash' WHERE email='$username'";
if ($query_run= mysqli_query($con,$query)){
