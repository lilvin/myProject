...
<form id="form1" name="form1" method="post" action="/donateblood/menu/recipientslogincon.php">
...
<!--second column-->
  ...
  <tr>
    <td bgcolor="#CC3366"><input name="password2" type="submit" id="password2" value="Change Password" onclick="location.href='/donateblood/password/recipientspassword.php'"/></td>
