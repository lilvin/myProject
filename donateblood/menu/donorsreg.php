...
<div id="templatemo_main">
  ...
  <form id="form1" name="form1" method="post" action="donorsregcon.php">
    <label></label>
    <p>
      <label></label>
    </p>
    <table width="332" border="1" align="center">
      <tr>
        <th colspan="2" scope="col">Create an account to start donating </th>
      </tr>
      <tr>
        <td width="112">ID number </td>
        <td width="204"><input name="ID" maxlength="8" type="text" id="ID" /></td>
      </tr>
      <tr>
        <td>First Name </td>
 ...
 <!-- <div id="register">
               ...
               <form method="post" name="contact" action="connectivity.php">
			                         <label for="ID">ID number:</label> <input type="text"  id="ID" name="ID" class="required input_field" />
                        ...
                        <div class="cleaner h10"></div>
						<label for="mobile">Mobile:</label> <input type="text" id="mobile" name="mobile" class="required input_field" />
                        <div class="cleaner h10"></div>
						<label for="username">Username:</label> <input type="text" id="username" name="username" class="required input_field" />
                        <div class="cleaner h10"></div>
						<label for="password">Password:</label> <input type="text" id="password" name="password" class="required input_field" />
                        <div class="cleaner h10"></div>
