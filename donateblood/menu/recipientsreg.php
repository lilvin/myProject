...
<div id="templatemo_main">
  ...
  <form id="form1" name="form1" method="post" action="recipientsregcon.php">
    <label></label>
    <p>
      <label></label>
    </p>
    <table width="332" border="1" align="center">
      <tr>
        <th colspan="2" scope="col">Create an account to start booking appointments for transfusion </th>
      </tr>
      <tr>
