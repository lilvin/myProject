...
$username = $_POST['username'];
  ...
  $query ="SELECT * FROM recipientsreg WHERE (email='$username' AND password='$password_hash')";
...
<div id="inputs" style="width:500px; height:300px; margin-left:100px; border:3px solid #a1a1a1">
<table width="500" height:300px; border="1" align="center" >
  <tr>
...
ID number:<br/>      
  <input name="ID" type="text" maxlength="8" id="ID" value="<?php echo $ID; ?>">
  <br/>
First name:<br/>    
<input name="firstname" type="text" maxlength="20" id="firstname" value="<?php echo $firstname; ?>">
<br/>
Last name:<br/> 
<input name="lastname" type="text" maxlength="20" id="lastname" value="<?php echo $lastname; ?>">
<br/>
Email address:<br/>
<input name="email" type="text" maxlength="50" id="email" value="<?php echo $email; ?>">
<br/>
Mobile:<br/>  
<input name="mobile" type="text" maxlength="10" id="mobile" value="<?php echo $mobile; ?>">
<br/>
<br/>
</form>
...
<!--second column--></th>
  ...
  <tr>
    <td width="150" bgcolor="#CC3366"><input name="update" type="submit" id="update" value="Update details"  onclick="location.href='/donateblood/menu/recipientsupdate.php'"/></td>
    <td width="1" bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366"><input name="password" type="submit" id="password" value="Change Password" onclick="location.href='/donateblood/password/recipientspassword.php'"/></td>
  ...
  <tr>
    <td bgcolor="#CC3366"><input name="appointment" type="submit" id="appointment" value="Book appointment" onclick="location.href='/donateblood/appointments/recipientsappointments.php'"/></td>
    <td bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366"><input name="cancel" type="submit" id="cancel" value="Cancel appointment" onclick="location.href='/donateblood/appointments/recipientscancel.php'"/></td>
    <td bgcolor="#CC3366">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#CC3366">&nbsp;</td>
...
<?php
  ...
  $password_hash=md5($password);
   ...
   if(!empty($ID) && !empty($firstname) && !empty($lastname) && !empty($email) && !empty($mobile) && !empty($password)){
	   ...
	   $query ="SELECT * FROM recipientsreg WHERE (ID='$ID' AND password='$password_hash')";
  
  if ($query_run= mysqli_query($con,$query)){
  	
        if(mysqli_num_rows($query_run)==1){
  
 $query= "UPDATE recipientsreg SET firstname='$firstname',lastname='$lastname', email='$email', mobile='$mobile' WHERE ID='$ID' AND password='$password_hash'";
if ($query_run= mysqli_query($con,$query)){
