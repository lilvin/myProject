...
<div id="templatemo_main">
  <form id="form1" name="form1" method="post" action="recipientslogincon.php">
    ...
    <table width="332" border="1" align="center">
      <tr>
        <th colspan="2" scope="col">Login to proceed. <a href="recipientsreg.php">Register</a> if you do not have an account.</th>
      </tr>
      <tr>
    ...
    <table width="330" border="1" align="center" style="margin-top:5px">
      <tr>
        <td><div align="center">
          <input name="forgot" type="submit" id="forgot" value="Forgot Password" onClick="location.href='/donateblood/password/recipientsforgot.php'"/>
        </div></td>
      </tr>
    </table>
  <p></p>
